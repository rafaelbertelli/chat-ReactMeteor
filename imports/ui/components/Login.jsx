        ...
        <div className='row'>
          <div className='col-lg-8 col-lg-offset-2 col-sm-12'>
            ...
            <div className="form-group">
              <input type="text" className="form-control" ref={(el) => {this.username = el}} placeholder="User"/>
            </div>

            {/* Senha */}
            <div className="form-group">
              <input type="password" className="form-control" ref={(el) => {this.password = el}} placeholder="Password"/>
            </div>
